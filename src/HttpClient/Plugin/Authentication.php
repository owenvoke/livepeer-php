...
namespace OwenVoke\Livepeer\HttpClient\Plugin;

use Http\Client\Common\Plugin;
use Http\Client\Common\Plugin\VersionBridgePlugin;
use Http\Promise\Promise;
use OwenVoke\Livepeer\Client;
use OwenVoke\Livepeer\Exception\RuntimeException;
...
final class Authentication implements Plugin
{
    ...
    /**
     * @param  string  $tokenOrLogin  Livepeer private token/username/client ID
     * @param  string|null  $password  Livepeer password/secret (optionally can contain $method)
